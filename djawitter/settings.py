"""
Django settings for djawitter project.
...
WSGI_APPLICATION = 'djawitter.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './djawitter.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
